...
The rewind tick is **derived, never trusted**: the shooter's newest snapshot
ack is a fact (it is literally their delta baseline), and what they rendered
when they fired is within a batch of it. Clamped to `rewind_max` (default
