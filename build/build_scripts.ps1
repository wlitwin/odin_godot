...
function BuildOneScriptsDir([string]$dir) {
    ...
    BuildDll $dir $out @("-custom-attribute:gd_method", "-custom-attribute:gd_connect", "-custom-attribute:gd_rpc", "-custom-attribute:gd_command", "-custom-attribute:gd_tick", "-custom-attribute:gd_sample", "-custom-attribute:gd_step")
