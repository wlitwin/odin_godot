...
| **Odin compiler — release `dev-2026-04`, exactly** (`odin` on your PATH) | <https://github.com/odin-lang/Odin/releases> |
...
> print `dev-2026-04`). A different release fails safely, with an error naming the
