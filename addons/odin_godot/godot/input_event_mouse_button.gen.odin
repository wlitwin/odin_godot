...
input_event_mouse_button_set_factor :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_factor", true)
...
input_event_mouse_button_get_factor :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_factor", true)
...
input_event_mouse_button_set_button_index :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_button_index", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3624991109)
    }
    self := self
...
input_event_mouse_button_get_button_index :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_button_index", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1132662608)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
input_event_mouse_button_set_double_click :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_double_click", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2586408642)
    }
    self := self
...
input_event_mouse_button_is_double_click :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("is_double_click", true)
...
// properties
input_event_mouse_button_get_double_click :: proc "contextless" (self: Input_Event_Mouse_Button) -> Bool {
    return input_event_mouse_button_is_double_click(self)
}
