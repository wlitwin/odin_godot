...
input_event_joypad_button_set_button_index :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1466368136)
    }
    self := self
...
input_event_joypad_button_get_button_index :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 595588182)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
