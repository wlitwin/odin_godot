...
Visual_Shader_Node_Sample3d_Source :: enum int {
    Source_Texture = 0,
    Source_Port = 1,
    Source_Max = 2,
}
...
visual_shader_node_sample3d_set_source :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3315130991)
    }
    self := self
    value_ := value_
...
visual_shader_node_sample3d_get_source :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1079494121)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
