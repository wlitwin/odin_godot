...
spin_box_set_prefix :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_prefix", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 83702148)
    }
    self := self
    prefix_ := prefix_
...
spin_box_get_prefix :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_prefix", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 201670096)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
spin_box_set_custom_arrow_step :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_custom_arrow_step", true)
...
spin_box_get_custom_arrow_step :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_custom_arrow_step", true)
...
spin_box_set_custom_arrow_round :: proc "contextless" (
    self: Spin_Box,
    round_: Bool,
) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_custom_arrow_round", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2586408642)
    }
    self := self
    round_ := round_
...
spin_box_is_custom_arrow_rounding :: proc "contextless" (
    self: Spin_Box,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("is_custom_arrow_rounding", true)
...
spin_box_set_update_on_text_changed :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_update_on_text_changed", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2586408642)
    }
    self := self
    enabled_ := enabled_
...
spin_box_get_update_on_text_changed :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_update_on_text_changed", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 36873697)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
spin_box_apply :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("apply", true)
...
// properties
spin_box_get_alignment :: proc "contextless" (self: Spin_Box) -> Horizontal_Alignment {
    return spin_box_get_horizontal_alignment(self)
}
spin_box_set_alignment :: proc "contextless" (self: Spin_Box, value: Horizontal_Alignment) {
    spin_box_set_horizontal_alignment(self, value)
}
spin_box_get_editable :: proc "contextless" (self: Spin_Box) -> Bool {
    return spin_box_is_editable(self)
}
spin_box_get_custom_arrow_round :: proc "contextless" (self: Spin_Box) -> Bool {
    return spin_box_is_custom_arrow_rounding(self)
}
spin_box_get_select_all_on_focus :: proc "contextless" (self: Spin_Box) -> Bool {
    return spin_box_is_select_all_on_focus(self)
}
