...
Visual_Shader_Node_Transform_Func_Function :: enum int {
    Func_Inverse = 0,
    Func_Transpose = 1,
    Func_Max = 2,
}
...
visual_shader_node_transform_func_set_function :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2900990409)
    }
    self := self
    func_ := func_
...
visual_shader_node_transform_func_get_function :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2839926569)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
