...
audio_stream_mp3_load_from_buffer :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1674970313)
    }
...
audio_stream_mp3_load_from_file :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4238362998)
    }
    path_ := path_
    args := []__bindgen_gde.TypePtr {
        &path_,
...
// properties
audio_stream_mp3_get_loop :: proc "contextless" (self: Audio_Stream_Mp3) -> Bool {
    return audio_stream_mp3_has_loop(self)
}
