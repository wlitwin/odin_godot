...
Visual_Shader_Node_Vector_Op_Operator :: enum int {
    Op_Add = 0,
    Op_Sub = 1,
    Op_Mul = 2,
    Op_Div = 3,
...
visual_shader_node_vector_op_set_operator :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3371507302)
    }
    self := self
    op_ := op_
...
visual_shader_node_vector_op_get_operator :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 11793929)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
