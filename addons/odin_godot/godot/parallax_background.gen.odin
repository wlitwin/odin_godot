...
parallax_background_set_scroll_base_offset :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_scroll_base_offset", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 743155724)
    }
    self := self
    offset_ := offset_
...
parallax_background_get_scroll_base_offset :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_scroll_base_offset", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3341600327)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
parallax_background_set_scroll_base_scale :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_scroll_base_scale", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 743155724)
    }
    self := self
    scale_ := scale_
...
parallax_background_get_scroll_base_scale :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_scroll_base_scale", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3341600327)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
parallax_background_set_ignore_camera_zoom :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_ignore_camera_zoom", true)
...
parallax_background_is_ignore_camera_zoom :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("is_ignore_camera_zoom", true)
...
// properties
parallax_background_get_scroll_limit_begin :: proc "contextless" (self: Parallax_Background) -> Vector2 {
    return parallax_background_get_limit_begin(self)
}
parallax_background_set_scroll_limit_begin :: proc "contextless" (self: Parallax_Background, value: Vector2) {
    parallax_background_set_limit_begin(self, value)
}
parallax_background_get_scroll_limit_end :: proc "contextless" (self: Parallax_Background) -> Vector2 {
    return parallax_background_get_limit_end(self)
}
parallax_background_set_scroll_limit_end :: proc "contextless" (self: Parallax_Background, value: Vector2) {
    parallax_background_set_limit_end(self, value)
}
parallax_background_get_scroll_ignore_camera_zoom :: proc "contextless" (self: Parallax_Background) -> Bool {
    return parallax_background_is_ignore_camera_zoom(self)
}
parallax_background_set_scroll_ignore_camera_zoom :: proc "contextless" (self: Parallax_Background, value: Bool) {
    parallax_background_set_ignore_camera_zoom(self, value)
}
