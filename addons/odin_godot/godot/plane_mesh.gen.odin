...
Plane_Mesh_Orientation :: enum int {
    Face_X = 0,
    Face_Y = 1,
    Face_Z = 2,
}
...
plane_mesh_set_center_offset :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_center_offset", true)
...
plane_mesh_get_center_offset :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_center_offset", true)
...
plane_mesh_set_orientation :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2751399687)
    }
    self := self
...
plane_mesh_get_orientation :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3227599250)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
