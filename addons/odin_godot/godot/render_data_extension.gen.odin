...
render_data_extension__get_render_scene_buffers :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_render_scene_buffers", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2793216201)
    }
    self := self
...
render_data_extension__get_render_scene_data :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_render_scene_data", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1288715698)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
render_data_extension__get_environment :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_environment", true)
...
render_data_extension__get_camera_attributes :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_camera_attributes", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2944877500)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
