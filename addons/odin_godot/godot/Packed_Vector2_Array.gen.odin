...
packed_vector2_array_get :: proc "contextless" (
...
packed_vector2_array_size :: proc "contextless" (
    self: ^Packed_Vector2_Array,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector2_array_is_empty :: proc "contextless" (
    self: ^Packed_Vector2_Array,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector2_array_push_back :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector2_array_append :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector2_array_append_array :: proc "contextless" (
    self: ^Packed_Vector2_Array,
...
packed_vector2_array_remove_at :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    index_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector2_array_insert :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    at_index_: Int,
    value_: Vector2,
) -> (ret: Int) {
...
packed_vector2_array_fill :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector2_array_resize :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    new_size_: Int,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector2_array_clear :: proc "contextless" (
    self: ^Packed_Vector2_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector2_array_has :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector2_array_reverse :: proc "contextless" (
    self: ^Packed_Vector2_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector2_array_slice :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    begin_: Int,
    end_: Int,
) -> (ret: Packed_Vector2_Array) {
...
packed_vector2_array_to_byte_array :: proc "contextless" (
    self: ^Packed_Vector2_Array,
...
packed_vector2_array_sort :: proc "contextless" (
    self: ^Packed_Vector2_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector2_array_bsearch :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
    before_: Bool,
) -> (ret: Int) {
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector2_Array, &_gde_name, 3341588170)
    }
    value_ := value_
    before_ := before_
    args := []__bindgen_gde.TypePtr {
...
packed_vector2_array_duplicate :: proc "contextless" (
    self: ^Packed_Vector2_Array,
) -> (ret: Packed_Vector2_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("duplicate", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector2_Array, &_gde_name, 1660374357)
    }
    args := []__bindgen_gde.TypePtr {
    }
    __ptr(self, raw_data(args), &ret, len(args))
...
packed_vector2_array_find :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
    from_: Int,
) -> (ret: Int) {
...
packed_vector2_array_rfind :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
    from_: Int,
) -> (ret: Int) {
...
packed_vector2_array_count :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector2_array_erase :: proc "contextless" (
    self: ^Packed_Vector2_Array,
    value_: Vector2,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
