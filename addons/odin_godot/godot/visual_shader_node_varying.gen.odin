...
visual_shader_node_varying_set_varying_name :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_varying_name", true)
...
visual_shader_node_varying_get_varying_name :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_varying_name", true)
...
visual_shader_node_varying_set_varying_type :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_varying_type", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3565867981)
    }
    self := self
    type_ := type_
    args := []__bindgen_gde.TypePtr {
...
visual_shader_node_varying_get_varying_type :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_varying_type", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 523183580)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
