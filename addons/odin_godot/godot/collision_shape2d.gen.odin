...
// properties
collision_shape2d_get_disabled :: proc "contextless" (self: Collision_Shape2d) -> Bool {
    return collision_shape2d_is_disabled(self)
}
collision_shape2d_get_one_way_collision :: proc "contextless" (self: Collision_Shape2d) -> Bool {
    return collision_shape2d_is_one_way_collision_enabled(self)
}
