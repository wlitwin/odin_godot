...
compressed_texture_layered_get_load_path :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_load_path", true)
...
// properties
compressed_texture_layered_set_load_path :: proc "contextless" (self: Compressed_Texture_Layered, value: String) {
    compressed_texture_layered_load(self, value)
}
