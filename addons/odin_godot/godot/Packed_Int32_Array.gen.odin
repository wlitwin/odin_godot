...
packed_int32_array_get :: proc "contextless" (
...
packed_int32_array_set :: proc "contextless" (
    self: ^Packed_Int32_Array,
    index_: Int,
    value_: Int,
) {
...
packed_int32_array_size :: proc "contextless" (
    self: ^Packed_Int32_Array,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_int32_array_is_empty :: proc "contextless" (
    self: ^Packed_Int32_Array,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_int32_array_push_back :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_int32_array_append :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_int32_array_append_array :: proc "contextless" (
    self: ^Packed_Int32_Array,
...
packed_int32_array_remove_at :: proc "contextless" (
    self: ^Packed_Int32_Array,
    index_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_int32_array_insert :: proc "contextless" (
    self: ^Packed_Int32_Array,
    at_index_: Int,
    value_: Int,
) -> (ret: Int) {
...
packed_int32_array_fill :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_int32_array_resize :: proc "contextless" (
    self: ^Packed_Int32_Array,
    new_size_: Int,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_int32_array_clear :: proc "contextless" (
    self: ^Packed_Int32_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_int32_array_has :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_int32_array_reverse :: proc "contextless" (
    self: ^Packed_Int32_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_int32_array_slice :: proc "contextless" (
    self: ^Packed_Int32_Array,
    begin_: Int,
    end_: Int,
) -> (ret: Packed_Int32_Array) {
...
packed_int32_array_to_byte_array :: proc "contextless" (
    self: ^Packed_Int32_Array,
...
packed_int32_array_sort :: proc "contextless" (
    self: ^Packed_Int32_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_int32_array_bsearch :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
    before_: Bool,
) -> (ret: Int) {
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Int32_Array, &_gde_name, 954237325)
    }
    value_ := value_
    before_ := before_
    args := []__bindgen_gde.TypePtr {
...
packed_int32_array_duplicate :: proc "contextless" (
    self: ^Packed_Int32_Array,
) -> (ret: Packed_Int32_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("duplicate", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Int32_Array, &_gde_name, 3158844420)
    }
    args := []__bindgen_gde.TypePtr {
    }
    __ptr(self, raw_data(args), &ret, len(args))
...
packed_int32_array_find :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
    from_: Int,
) -> (ret: Int) {
...
packed_int32_array_rfind :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
    from_: Int,
) -> (ret: Int) {
...
packed_int32_array_count :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_int32_array_erase :: proc "contextless" (
    self: ^Packed_Int32_Array,
    value_: Int,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
