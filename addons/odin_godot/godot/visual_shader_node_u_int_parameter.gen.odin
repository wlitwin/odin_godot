...
// properties
visual_shader_node_u_int_parameter_get_default_value_enabled :: proc "contextless" (self: Visual_Shader_Node_U_Int_Parameter) -> Bool {
    return visual_shader_node_u_int_parameter_is_default_value_enabled(self)
}
