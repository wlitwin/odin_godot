...
open_xr_binding_modifier_editor_get_binding_modifier :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2930765082)
    }
    self := self
...
open_xr_binding_modifier_editor_setup :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1284787389)
    }
    self := self
