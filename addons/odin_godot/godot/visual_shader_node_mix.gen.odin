...
Visual_Shader_Node_Mix_Op_Type :: enum int {
    Op_Type_Scalar = 0,
    Op_Type_Vector_2d = 1,
...
visual_shader_node_mix_set_op_type :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3397501671)
    }
    self := self
    op_type_ := op_type_
...
visual_shader_node_mix_get_op_type :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4013957297)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
