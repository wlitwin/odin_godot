...
video_stream__instantiate_playback :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_instantiate_playback", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 294648086)
    }
    self := self
...
video_stream_set_file :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_file", true)
