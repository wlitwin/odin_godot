...
Visible_On_Screen_Enabler3d_Enable_Mode :: enum int {
...
visible_on_screen_enabler3d_set_enable_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 320303646)
    }
    self := self
    mode_ := mode_
...
visible_on_screen_enabler3d_get_enable_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3352990031)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
