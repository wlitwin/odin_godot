...
viewport_texture_set_viewport_path_in_scene :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_viewport_path_in_scene", true)
...
viewport_texture_get_viewport_path_in_scene :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_viewport_path_in_scene", true)
...
// properties
viewport_texture_get_viewport_path :: proc "contextless" (self: Viewport_Texture) -> Node_Path {
    return viewport_texture_get_viewport_path_in_scene(self)
}
viewport_texture_set_viewport_path :: proc "contextless" (self: Viewport_Texture, value: Node_Path) {
    viewport_texture_set_viewport_path_in_scene(self, value)
}
