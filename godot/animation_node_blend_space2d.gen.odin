...
Animation_Node_Blend_Space2d_Blend_Mode :: enum int {
...
animation_node_blend_space2d_add_triangle :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("add_triangle", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 753017335)
    }
    self := self
    x_ := x_
    y_ := y_
...
animation_node_blend_space2d_get_triangle_point :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_triangle_point", true)
...
animation_node_blend_space2d_remove_triangle :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("remove_triangle", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1286410249)
    }
    self := self
    triangle_ := triangle_
...
animation_node_blend_space2d_get_triangle_count :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_triangle_count", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3905245786)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
animation_node_blend_space2d_set_x_label :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_x_label", true)
...
animation_node_blend_space2d_get_x_label :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_x_label", true)
...
animation_node_blend_space2d_set_y_label :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_y_label", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 83702148)
    }
    self := self
    text_ := text_
...
animation_node_blend_space2d_get_y_label :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_y_label", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 201670096)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
animation_node_blend_space2d_set_auto_triangles :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_auto_triangles", true)
...
animation_node_blend_space2d_get_auto_triangles :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_auto_triangles", true)
...
animation_node_blend_space2d_set_blend_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 81193520)
    }
    self := self
    mode_ := mode_
    args := []__bindgen_gde.TypePtr {
...
animation_node_blend_space2d_get_blend_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1398433632)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
// properties
animation_node_blend_space2d_get_sync :: proc "contextless" (self: Animation_Node_Blend_Space2d) -> Bool {
    return animation_node_blend_space2d_is_using_sync(self)
}
animation_node_blend_space2d_set_sync :: proc "contextless" (self: Animation_Node_Blend_Space2d, value: Bool) {
    animation_node_blend_space2d_set_use_sync(self, value)
}
