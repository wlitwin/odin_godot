...
visual_shader_node_particle_emitter_set_mode_2d :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_mode_2d", true)
...
visual_shader_node_particle_emitter_is_mode_2d :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("is_mode_2d", true)
...
// properties
visual_shader_node_particle_emitter_get_mode_2d :: proc "contextless" (self: Visual_Shader_Node_Particle_Emitter) -> Bool {
    return visual_shader_node_particle_emitter_is_mode_2d(self)
}
