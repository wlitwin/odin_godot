...
Visual_Shader_Node_Multiply_Add_Op_Type :: enum int {
    Op_Type_Scalar = 0,
    Op_Type_Vector_2d = 1,
    Op_Type_Vector_3d = 2,
    Op_Type_Vector_4d = 3,
...
visual_shader_node_multiply_add_set_op_type :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1409862380)
    }
    self := self
    type_ := type_
...
visual_shader_node_multiply_add_get_op_type :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2823201991)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
