...
// Godot 4.5+ typed dictionaries. A thin, self-documenting wrapper over an
// untyped `Dictionary` that records its key/value types (`K`/`V`) in the type,
// mirroring `Typed_Array(T)`. Generated bindings render
// `typeddictionary::K;V` as `Typed_Dictionary(K, V)`.
