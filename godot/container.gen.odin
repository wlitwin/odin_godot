...
container__get_allowed_size_flags_horizontal :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_allowed_size_flags_horizontal", true)
...
container__get_allowed_size_flags_vertical :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_allowed_size_flags_vertical", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1930428628)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
container_queue_sort :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("queue_sort", true)
...
container_fit_child_in_rect :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("fit_child_in_rect", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1993438598)
    }
    self := self
    child_ := child_
    rect_ := rect_
