...
visual_instance3d_set_base :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_base", true)
...
visual_instance3d_get_base :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_base", true)
...
visual_instance3d_set_layer_mask_value :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_layer_mask_value", true)
...
visual_instance3d_get_layer_mask_value :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_layer_mask_value", true)
...
visual_instance3d_set_sorting_offset :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_sorting_offset", true)
...
visual_instance3d_get_sorting_offset :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_sorting_offset", true)
...
visual_instance3d_set_sorting_use_aabb_center :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_sorting_use_aabb_center", true)
...
visual_instance3d_is_sorting_use_aabb_center :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("is_sorting_use_aabb_center", true)
...
// properties
visual_instance3d_get_layers :: proc "contextless" (self: Visual_Instance3d) -> u32 {
    return visual_instance3d_get_layer_mask(self)
}
visual_instance3d_set_layers :: proc "contextless" (self: Visual_Instance3d, value: Int) {
    visual_instance3d_set_layer_mask(self, value)
}
visual_instance3d_get_sorting_use_aabb_center :: proc "contextless" (self: Visual_Instance3d) -> Bool {
    return visual_instance3d_is_sorting_use_aabb_center(self)
}
