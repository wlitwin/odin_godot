...
ray_cast2d_add_exception :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3090941106)
    }
    self := self
    node_ := node_
    args := []__bindgen_gde.TypePtr {
...
// properties
ray_cast2d_get_enabled :: proc "contextless" (self: Ray_Cast2d) -> Bool {
    return ray_cast2d_is_enabled(self)
}
ray_cast2d_get_exclude_parent :: proc "contextless" (self: Ray_Cast2d) -> Bool {
    return ray_cast2d_get_exclude_parent_body(self)
}
ray_cast2d_set_exclude_parent :: proc "contextless" (self: Ray_Cast2d, value: Bool) {
    ray_cast2d_set_exclude_parent_body(self, value)
}
ray_cast2d_get_hit_from_inside :: proc "contextless" (self: Ray_Cast2d) -> Bool {
    return ray_cast2d_is_hit_from_inside_enabled(self)
}
ray_cast2d_get_collide_with_areas :: proc "contextless" (self: Ray_Cast2d) -> Bool {
    return ray_cast2d_is_collide_with_areas_enabled(self)
}
ray_cast2d_get_collide_with_bodies :: proc "contextless" (self: Ray_Cast2d) -> Bool {
    return ray_cast2d_is_collide_with_bodies_enabled(self)
}
