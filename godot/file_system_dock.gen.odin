...
file_system_dock_navigate_to_path :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("navigate_to_path", true)
...
file_system_dock_add_resource_tooltip_plugin :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("add_resource_tooltip_plugin", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2258356838)
    }
    self := self
    plugin_ := plugin_
    args := []__bindgen_gde.TypePtr {
...
file_system_dock_remove_resource_tooltip_plugin :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("remove_resource_tooltip_plugin", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2258356838)
    }
    self := self
    plugin_ := plugin_
