...
physics_test_motion_parameters3d_get_max_collisions :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_max_collisions", true)
...
physics_test_motion_parameters3d_set_max_collisions :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_max_collisions", true)
...
// properties
physics_test_motion_parameters3d_get_collide_separation_ray :: proc "contextless" (self: Physics_Test_Motion_Parameters3d) -> Bool {
    return physics_test_motion_parameters3d_is_collide_separation_ray_enabled(self)
}
physics_test_motion_parameters3d_set_collide_separation_ray :: proc "contextless" (self: Physics_Test_Motion_Parameters3d, value: Bool) {
    physics_test_motion_parameters3d_set_collide_separation_ray_enabled(self, value)
}
physics_test_motion_parameters3d_get_recovery_as_collision :: proc "contextless" (self: Physics_Test_Motion_Parameters3d) -> Bool {
    return physics_test_motion_parameters3d_is_recovery_as_collision_enabled(self)
}
physics_test_motion_parameters3d_set_recovery_as_collision :: proc "contextless" (self: Physics_Test_Motion_Parameters3d, value: Bool) {
    physics_test_motion_parameters3d_set_recovery_as_collision_enabled(self, value)
}
