...
new_physics_direct_body_state3d_extension :: proc "contextless" () -> Physics_Direct_Body_State3d_Extension {
    return cast(Physics_Direct_Body_State3d_Extension)__bindgen_gde.classdb_construct_object(physics_direct_body_state3d_extension_name_ref())
}
...
physics_direct_body_state3d_extension__get_principal_inertia_axes :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_principal_inertia_axes", true)
...
physics_direct_body_state3d_extension__get_inverse_inertia_tensor :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_inverse_inertia_tensor", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2716978435)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
physics_direct_body_state3d_extension__apply_impulse :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1714681797)
    }
    self := self
    impulse_ := impulse_
    position_ := position_
