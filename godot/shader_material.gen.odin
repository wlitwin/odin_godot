...
shader_material_set_shader :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3341921675)
    }
    self := self
    shader_ := shader_
...
shader_material_get_shader :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2078273437)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
shader_material_set_shader_parameter :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_shader_parameter", true)
...
shader_material_get_shader_parameter :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_shader_parameter", true)
