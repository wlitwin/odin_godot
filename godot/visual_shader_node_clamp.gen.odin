...
Visual_Shader_Node_Clamp_Op_Type :: enum int {
    Op_Type_Float = 0,
    Op_Type_Int = 1,
    Op_Type_Uint = 2,
    Op_Type_Vector_2d = 3,
...
visual_shader_node_clamp_set_op_type :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 405010749)
    }
    self := self
    op_type_ := op_type_
...
visual_shader_node_clamp_get_op_type :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 233276050)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
