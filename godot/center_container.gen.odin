...
center_container_set_use_top_left :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_use_top_left", true)
...
center_container_is_using_top_left :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("is_using_top_left", true)
...
// properties
center_container_get_use_top_left :: proc "contextless" (self: Center_Container) -> Bool {
    return center_container_is_using_top_left(self)
}
