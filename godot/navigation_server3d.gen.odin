...
Navigation_Server3d_Process_Info :: enum int {
    Info_Active_Maps = 0,
    Info_Region_Count = 1,
    Info_Agent_Count = 2,
    Info_Link_Count = 3,
...
navigation_server3d_map_set_up :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("map_set_up", true)
...
navigation_server3d_map_get_up :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("map_get_up", true)
...
navigation_server3d_map_set_cell_height :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("map_set_cell_height", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1794382983)
    }
    self := self
    map_ := map_
...
navigation_server3d_map_get_cell_height :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("map_get_cell_height", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 866169185)
    }
    self := self
    map_ := map_
...
navigation_server3d_map_get_path :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 276783190)
    }
    self := self
    map_ := map_
    origin_ := origin_
...
navigation_server3d_map_get_closest_point_to_segment :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("map_get_closest_point_to_segment", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3830095642)
    }
    self := self
    map_ := map_
    start_ := start_
...
navigation_server3d_map_get_closest_point_normal :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("map_get_closest_point_normal", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2056183332)
    }
    self := self
    map_ := map_
...
navigation_server3d_map_get_closest_point_owner :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 553364610)
    }
    self := self
    map_ := map_
    to_point_ := to_point_
...
navigation_server3d_map_get_random_point :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 722801526)
    }
    self := self
    map_ := map_
    navigation_layers_ := navigation_layers_
...
navigation_server3d_query_path :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2146930868)
    }
    self := self
...
navigation_server3d_region_owns_point :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2360011153)
    }
    self := self
    region_ := region_
    point_ := point_
...
navigation_server3d_region_set_navigation_mesh :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("region_set_navigation_mesh", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2764952978)
    }
    self := self
    region_ := region_
...
navigation_server3d_region_bake_navigation_mesh :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("region_bake_navigation_mesh", true)
...
navigation_server3d_region_get_closest_point_to_segment :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("region_get_closest_point_to_segment", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3830095642)
    }
    self := self
    region_ := region_
...
navigation_server3d_region_get_closest_point_normal :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("region_get_closest_point_normal", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2056183332)
    }
    self := self
    region_ := region_
...
navigation_server3d_agent_set_use_3d_avoidance :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("agent_set_use_3d_avoidance", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1265174801)
    }
    self := self
    agent_ := agent_
...
navigation_server3d_agent_get_use_3d_avoidance :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("agent_get_use_3d_avoidance", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4155700596)
    }
    self := self
    agent_ := agent_
...
navigation_server3d_agent_set_height :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("agent_set_height", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1794382983)
    }
    self := self
    agent_ := agent_
...
navigation_server3d_agent_get_height :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("agent_get_height", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 866169185)
    }
    self := self
    agent_ := agent_
...
navigation_server3d_obstacle_set_use_3d_avoidance :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("obstacle_set_use_3d_avoidance", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1265174801)
    }
    self := self
    obstacle_ := obstacle_
...
navigation_server3d_obstacle_get_use_3d_avoidance :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("obstacle_get_use_3d_avoidance", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4155700596)
    }
    self := self
    obstacle_ := obstacle_
...
navigation_server3d_obstacle_set_height :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("obstacle_set_height", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1794382983)
    }
    self := self
    obstacle_ := obstacle_
...
navigation_server3d_obstacle_get_height :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("obstacle_get_height", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 866169185)
    }
    self := self
    obstacle_ := obstacle_
...
navigation_server3d_obstacle_set_vertices :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4030257846)
    }
    self := self
    obstacle_ := obstacle_
    vertices_ := vertices_
...
navigation_server3d_is_baking_navigation_mesh :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("is_baking_navigation_mesh", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3142026141)
    }
    self := self
    navigation_mesh_ := navigation_mesh_
    args := []__bindgen_gde.TypePtr {
...
navigation_server3d_simplify_path :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2344122170)
    }
    self := self
    path_ := path_
    epsilon_ := epsilon_
...
navigation_server3d_get_process_info :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1938440894)
    }
    self := self
