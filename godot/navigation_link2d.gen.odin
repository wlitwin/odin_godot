...
// properties
navigation_link2d_get_enabled :: proc "contextless" (self: Navigation_Link2d) -> Bool {
    return navigation_link2d_is_enabled(self)
}
navigation_link2d_get_bidirectional :: proc "contextless" (self: Navigation_Link2d) -> Bool {
    return navigation_link2d_is_bidirectional(self)
}
