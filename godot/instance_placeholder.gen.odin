...
instance_placeholder_get_stored_values :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_stored_values", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2230153369)
    }
    self := self
...
instance_placeholder_create_instance :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3794612210)
    }
    self := self
    replace_ := replace_
...
instance_placeholder_get_instance_path :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_instance_path", true)
