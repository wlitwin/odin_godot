...
physics_direct_space_state2d_extension__intersect_ray :: proc "contextless" (
    ...
    r_result_: ^Physics_Server2d_Extension_Ray_Result,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_intersect_ray", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2840492092)
    }
    self := self
    from_ := from_
    to_ := to_
...
physics_direct_space_state2d_extension__intersect_point :: proc "contextless" (
    ...
    collide_with_bodies_: Bool,
    collide_with_areas_: Bool,
    r_results_: ^Physics_Server2d_Extension_Shape_Result,
    max_results_: Int,
) -> (ret: i32) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_intersect_point", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 522407812)
    }
    self := self
    position_ := position_
...
physics_direct_space_state2d_extension__intersect_shape :: proc "contextless" (
    ...
    collide_with_bodies_: Bool,
    collide_with_areas_: Bool,
    r_result_: ^Physics_Server2d_Extension_Shape_Result,
    max_results_: Int,
) -> (ret: i32) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_intersect_shape", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1584897015)
    }
    self := self
...
physics_direct_space_state2d_extension__cast_motion :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1410701151)
    }
    self := self
    shape_rid_ := shape_rid_
    transform_ := transform_
...
physics_direct_space_state2d_extension__collide_shape :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 871510130)
    }
    self := self
    shape_rid_ := shape_rid_
    transform_ := transform_
...
physics_direct_space_state2d_extension__rest_info :: proc "contextless" (
    ...
    collide_with_bodies_: Bool,
    collide_with_areas_: Bool,
    r_rest_info_: ^Physics_Server2d_Extension_Shape_Rest_Info,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_rest_info", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 772675997)
    }
    self := self
    shape_rid_ := shape_rid_
    transform_ := transform_
