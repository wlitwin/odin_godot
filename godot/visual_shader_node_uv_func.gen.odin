...
Visual_Shader_Node_Uv_Func_Function :: enum int {
    Func_Panning = 0,
    Func_Scaling = 1,
    Func_Max = 2,
}
...
visual_shader_node_uv_func_set_function :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 765791915)
    }
    self := self
    func_ := func_
...
visual_shader_node_uv_func_get_function :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3772902164)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
