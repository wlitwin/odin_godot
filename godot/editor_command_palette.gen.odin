...
editor_command_palette_add_command :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("add_command", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 864043298)
    }
    self := self
...
editor_command_palette_remove_command :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("remove_command", true)
