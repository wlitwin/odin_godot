...
cylinder_mesh_set_top_radius :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_top_radius", true)
...
cylinder_mesh_get_top_radius :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_top_radius", true)
...
cylinder_mesh_set_bottom_radius :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_bottom_radius", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 373806689)
    }
    self := self
    radius_ := radius_
...
cylinder_mesh_get_bottom_radius :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_bottom_radius", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1740695150)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
// properties
cylinder_mesh_get_cap_top :: proc "contextless" (self: Cylinder_Mesh) -> Bool {
    return cylinder_mesh_is_cap_top(self)
}
cylinder_mesh_get_cap_bottom :: proc "contextless" (self: Cylinder_Mesh) -> Bool {
    return cylinder_mesh_is_cap_bottom(self)
}
