...
// properties
remote_transform2d_get_remote_path :: proc "contextless" (self: Remote_Transform2d) -> Node_Path {
    return remote_transform2d_get_remote_node(self)
}
remote_transform2d_set_remote_path :: proc "contextless" (self: Remote_Transform2d, value: Node_Path) {
    remote_transform2d_set_remote_node(self, value)
}
