...
physics_ray_query_parameters3d_create :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3110599579)
    }
    from_ := from_
    to_ := to_
...
// properties
physics_ray_query_parameters3d_get_collide_with_bodies :: proc "contextless" (self: Physics_Ray_Query_Parameters3d) -> Bool {
    return physics_ray_query_parameters3d_is_collide_with_bodies_enabled(self)
}
physics_ray_query_parameters3d_get_collide_with_areas :: proc "contextless" (self: Physics_Ray_Query_Parameters3d) -> Bool {
    return physics_ray_query_parameters3d_is_collide_with_areas_enabled(self)
}
physics_ray_query_parameters3d_get_hit_from_inside :: proc "contextless" (self: Physics_Ray_Query_Parameters3d) -> Bool {
    return physics_ray_query_parameters3d_is_hit_from_inside_enabled(self)
}
physics_ray_query_parameters3d_get_hit_back_faces :: proc "contextless" (self: Physics_Ray_Query_Parameters3d) -> Bool {
    return physics_ray_query_parameters3d_is_hit_back_faces_enabled(self)
}
