...
new_marker2d :: proc "contextless" () -> Marker2d {
    return cast(Marker2d)__bindgen_gde.classdb_construct_object(marker2d_name_ref())
}
...
marker2d_set_gizmo_extents :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_gizmo_extents", true)
...
marker2d_get_gizmo_extents :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_gizmo_extents", true)
