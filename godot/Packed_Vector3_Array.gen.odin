...
packed_vector3_array_get :: proc "contextless" (
...
packed_vector3_array_size :: proc "contextless" (
    self: ^Packed_Vector3_Array,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector3_array_is_empty :: proc "contextless" (
    self: ^Packed_Vector3_Array,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector3_array_push_back :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector3_array_append :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector3_array_append_array :: proc "contextless" (
    self: ^Packed_Vector3_Array,
...
packed_vector3_array_remove_at :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    index_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector3_array_insert :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    at_index_: Int,
    value_: Vector3,
) -> (ret: Int) {
...
packed_vector3_array_fill :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector3_array_resize :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    new_size_: Int,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector3_array_clear :: proc "contextless" (
    self: ^Packed_Vector3_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector3_array_has :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector3_array_reverse :: proc "contextless" (
    self: ^Packed_Vector3_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector3_array_slice :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    begin_: Int,
    end_: Int,
) -> (ret: Packed_Vector3_Array) {
...
packed_vector3_array_to_byte_array :: proc "contextless" (
    self: ^Packed_Vector3_Array,
...
packed_vector3_array_sort :: proc "contextless" (
    self: ^Packed_Vector3_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_vector3_array_bsearch :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
    before_: Bool,
) -> (ret: Int) {
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector3_Array, &_gde_name, 1259277637)
    }
    value_ := value_
    before_ := before_
    args := []__bindgen_gde.TypePtr {
...
packed_vector3_array_duplicate :: proc "contextless" (
    self: ^Packed_Vector3_Array,
) -> (ret: Packed_Vector3_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("duplicate", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_Vector3_Array, &_gde_name, 4171207452)
    }
    args := []__bindgen_gde.TypePtr {
    }
    __ptr(self, raw_data(args), &ret, len(args))
...
packed_vector3_array_find :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
    from_: Int,
) -> (ret: Int) {
...
packed_vector3_array_rfind :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
    from_: Int,
) -> (ret: Int) {
...
packed_vector3_array_count :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_vector3_array_erase :: proc "contextless" (
    self: ^Packed_Vector3_Array,
    value_: Vector3,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
