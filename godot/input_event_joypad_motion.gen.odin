...
input_event_joypad_motion_set_axis :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1332685170)
    }
    self := self
    axis_ := axis_
...
input_event_joypad_motion_get_axis :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4019121683)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
input_event_joypad_motion_set_axis_value :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_axis_value", true)
...
input_event_joypad_motion_get_axis_value :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_axis_value", true)
