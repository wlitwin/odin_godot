...
visual_shader_node_frame_add_attached_node :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("add_attached_node", true)
...
visual_shader_node_frame_remove_attached_node :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("remove_attached_node", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1286410249)
    }
    self := self
    node_ := node_
...
visual_shader_node_frame_set_attached_nodes :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_attached_nodes", true)
...
visual_shader_node_frame_get_attached_nodes :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_attached_nodes", true)
...
// properties
visual_shader_node_frame_get_tint_color_enabled :: proc "contextless" (self: Visual_Shader_Node_Frame) -> Bool {
    return visual_shader_node_frame_is_tint_color_enabled(self)
}
visual_shader_node_frame_get_autoshrink :: proc "contextless" (self: Visual_Shader_Node_Frame) -> Bool {
    return visual_shader_node_frame_is_autoshrink_enabled(self)
}
visual_shader_node_frame_set_autoshrink :: proc "contextless" (self: Visual_Shader_Node_Frame, value: Bool) {
    visual_shader_node_frame_set_autoshrink_enabled(self, value)
}
