...
Visual_Shader_Node_Vector_Base_Op_Type :: enum int {
    Op_Type_Vector_2d = 0,
    Op_Type_Vector_3d = 1,
    Op_Type_Vector_4d = 2,
    Op_Type_Max = 3,
...
visual_shader_node_vector_base_set_op_type :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1692596998)
    }
    self := self
    type_ := type_
...
visual_shader_node_vector_base_get_op_type :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2568738462)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
