...
visual_shader_node_curve_texture_set_texture :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 181872837)
    }
    self := self
    texture_ := texture_
...
visual_shader_node_curve_texture_get_texture :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2800800579)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
