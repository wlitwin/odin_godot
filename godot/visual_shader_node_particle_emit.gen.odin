...
Visual_Shader_Node_Particle_Emit_Emit_Flags :: enum int {
...
visual_shader_node_particle_emit_set_flags :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3960756792)
    }
    self := self
    flags_ := flags_
...
visual_shader_node_particle_emit_get_flags :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 171277835)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
