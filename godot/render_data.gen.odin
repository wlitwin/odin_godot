...
new_render_data :: proc "contextless" () -> Render_Data {
    return cast(Render_Data)__bindgen_gde.classdb_construct_object(render_data_name_ref())
}
...
render_data_get_render_scene_buffers :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_render_scene_buffers", true)
...
render_data_get_render_scene_data :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_render_scene_data", true)
