...
Collision_Object3d_Disable_Mode :: enum int {
...
collision_object3d__input_event :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2310605070)
    }
    self := self
    camera_ := camera_
    event_ := event_
...
collision_object3d_set_disable_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1623620376)
    }
    self := self
    mode_ := mode_
    args := []__bindgen_gde.TypePtr {
...
collision_object3d_get_disable_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 410164780)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
collision_object3d_set_capture_input_on_drag :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_capture_input_on_drag", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2586408642)
    }
    self := self
    enable_ := enable_
...
collision_object3d_get_capture_input_on_drag :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_capture_input_on_drag", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 36873697)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
collision_object3d_shape_owner_add_shape :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2566676345)
    }
    self := self
    owner_id_ := owner_id_
    shape_ := shape_
...
collision_object3d_shape_owner_get_shape :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4015519174)
    }
    self := self
    owner_id_ := owner_id_
    shape_id_ := shape_id_
...
// properties
collision_object3d_get_input_ray_pickable :: proc "contextless" (self: Collision_Object3d) -> Bool {
    return collision_object3d_is_ray_pickable(self)
}
collision_object3d_set_input_ray_pickable :: proc "contextless" (self: Collision_Object3d, value: Bool) {
    collision_object3d_set_ray_pickable(self, value)
}
collision_object3d_get_input_capture_on_drag :: proc "contextless" (self: Collision_Object3d) -> Bool {
    return collision_object3d_get_capture_input_on_drag(self)
}
collision_object3d_set_input_capture_on_drag :: proc "contextless" (self: Collision_Object3d, value: Bool) {
    collision_object3d_set_capture_input_on_drag(self, value)
}
