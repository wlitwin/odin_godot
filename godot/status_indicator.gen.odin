...
status_indicator_set_tooltip :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_tooltip", true)
...
status_indicator_set_menu :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_menu", true)
...
// properties
status_indicator_get_visible :: proc "contextless" (self: Status_Indicator) -> Bool {
    return status_indicator_is_visible(self)
}
