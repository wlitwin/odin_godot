...
new_render_scene_data_extension :: proc "contextless" () -> Render_Scene_Data_Extension {
    return cast(Render_Scene_Data_Extension)__bindgen_gde.classdb_construct_object(render_scene_data_extension_name_ref())
}
...
render_scene_data_extension__get_cam_transform :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_cam_transform", true)
...
render_scene_data_extension__get_cam_projection :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_cam_projection", true)
...
render_scene_data_extension__get_view_eye_offset :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_view_eye_offset", true)
...
render_scene_data_extension__get_view_projection :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_view_projection", true)
...
render_scene_data_extension__get_uniform_buffer :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("_get_uniform_buffer", true)
