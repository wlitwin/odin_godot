...
Xr_Body_Modifier3d_Bone_Update :: enum int {
    Bone_Update_Full = 0,
    Bone_Update_Rotation_Only = 1,
    Bone_Update_Max = 2,
}

Xr_Body_Modifier3d_Body_Update :: enum i64 {
...
new_xr_body_modifier3d :: proc "contextless" () -> Xr_Body_Modifier3d {
    return cast(Xr_Body_Modifier3d)__bindgen_gde.classdb_construct_object(xr_body_modifier3d_name_ref())
}
...
xr_body_modifier3d_set_body_tracker :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_body_tracker", true)
...
xr_body_modifier3d_get_body_tracker :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_body_tracker", true)
...
xr_body_modifier3d_set_body_update :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_body_update", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2211199417)
    }
    self := self
...
xr_body_modifier3d_get_body_update :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_body_update", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2642335328)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
xr_body_modifier3d_set_bone_update :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3356796943)
    }
    self := self
...
xr_body_modifier3d_get_bone_update :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1309305964)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
