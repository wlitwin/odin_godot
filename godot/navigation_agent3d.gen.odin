...
new_navigation_agent3d :: proc "contextless" () -> Navigation_Agent3d {
    return cast(Navigation_Agent3d)__bindgen_gde.classdb_construct_object(navigation_agent3d_name_ref())
}
...
navigation_agent3d_set_path_height_offset :: proc "contextless" (
    self: Navigation_Agent3d,
    path_height_offset_: f64,
) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_path_height_offset", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 373806689)
    }
    self := self
...
navigation_agent3d_get_path_height_offset :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_path_height_offset", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1740695150)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_agent3d_set_use_3d_avoidance :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_use_3d_avoidance", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2586408642)
    }
    self := self
    enabled_ := enabled_
...
navigation_agent3d_get_use_3d_avoidance :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_use_3d_avoidance", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 36873697)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_agent3d_set_keep_y_velocity :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_keep_y_velocity", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2586408642)
    }
    self := self
    enabled_ := enabled_
...
navigation_agent3d_get_keep_y_velocity :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_keep_y_velocity", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 36873697)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
navigation_agent3d_set_pathfinding_algorithm :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 394560454)
    }
    self := self
...
navigation_agent3d_get_pathfinding_algorithm :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3398491350)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
navigation_agent3d_set_path_postprocessing :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2267362344)
    }
    self := self
...
navigation_agent3d_get_path_postprocessing :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3883858360)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
navigation_agent3d_set_path_metadata_flags :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2713846708)
    }
    self := self
    flags_ := flags_
    args := []__bindgen_gde.TypePtr {
...
navigation_agent3d_get_path_metadata_flags :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1582332802)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
navigation_agent3d_get_current_navigation_result :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 728825684)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
