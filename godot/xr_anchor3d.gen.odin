...
new_xr_anchor3d :: proc "contextless" () -> Xr_Anchor3d {
    return cast(Xr_Anchor3d)__bindgen_gde.classdb_construct_object(xr_anchor3d_name_ref())
}
...
xr_anchor3d_get_plane :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_plane", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2753500971)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
