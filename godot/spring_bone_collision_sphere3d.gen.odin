...
new_spring_bone_collision_sphere3d :: proc "contextless" () -> Spring_Bone_Collision_Sphere3d {
    return cast(Spring_Bone_Collision_Sphere3d)__bindgen_gde.classdb_construct_object(spring_bone_collision_sphere3d_name_ref())
}
...
// properties
spring_bone_collision_sphere3d_get_inside :: proc "contextless" (self: Spring_Bone_Collision_Sphere3d) -> Bool {
    return spring_bone_collision_sphere3d_is_inside(self)
}
