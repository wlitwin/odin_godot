...
// properties
shape_cast2d_get_enabled :: proc "contextless" (self: Shape_Cast2d) -> Bool {
    return shape_cast2d_is_enabled(self)
}
shape_cast2d_get_exclude_parent :: proc "contextless" (self: Shape_Cast2d) -> Bool {
    return shape_cast2d_get_exclude_parent_body(self)
}
shape_cast2d_set_exclude_parent :: proc "contextless" (self: Shape_Cast2d, value: Bool) {
    shape_cast2d_set_exclude_parent_body(self, value)
}
shape_cast2d_get_collide_with_areas :: proc "contextless" (self: Shape_Cast2d) -> Bool {
    return shape_cast2d_is_collide_with_areas_enabled(self)
}
shape_cast2d_get_collide_with_bodies :: proc "contextless" (self: Shape_Cast2d) -> Bool {
    return shape_cast2d_is_collide_with_bodies_enabled(self)
}
