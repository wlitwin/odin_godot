...
Animation_Node_Blend_Space1d_Sync_Mode :: enum int {
    Sync_Mode_None = 0,
...
animation_node_blend_space1d_add_blend_point :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 398361042)
    }
    self := self
    node_ := node_
    pos_ := pos_
...
animation_node_blend_space1d_set_blend_point_name :: proc "contextless" (
    self: Animation_Node_Blend_Space1d,
    point_: Int,
    name_: String_Name,
) {
...
animation_node_blend_space1d_get_blend_point_name :: proc "contextless" (
    self: Animation_Node_Blend_Space1d,
    point_: Int,
) -> (ret: String_Name) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
...
animation_node_blend_space1d_find_blend_point_by_name :: proc "contextless" (
    self: Animation_Node_Blend_Space1d,
    name_: String_Name,
) -> (ret: i32) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
...
animation_node_blend_space1d_reorder_blend_point :: proc "contextless" (
    self: Animation_Node_Blend_Space1d,
    from_index_: Int,
    to_index_: Int,
) {
...
animation_node_blend_space1d_set_sync_mode :: proc "contextless" (
    self: Animation_Node_Blend_Space1d,
    sync_mode_: Animation_Node_Blend_Space1d_Sync_Mode,
) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_sync_mode", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1065895142)
    }
    self := self
...
animation_node_blend_space1d_get_sync_mode :: proc "contextless" (
    self: Animation_Node_Blend_Space1d,
) -> (ret: Animation_Node_Blend_Space1d_Sync_Mode) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_sync_mode", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 132474921)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
animation_node_blend_space1d_set_cyclic_length :: proc "contextless" (
    self: Animation_Node_Blend_Space1d,
    length_: f64,
) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
...
animation_node_blend_space1d_get_cyclic_length :: proc "contextless" (
    self: Animation_Node_Blend_Space1d,
) -> (ret: f64) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
