...
packed_string_array_set :: proc "contextless" (
    self: ^Packed_String_Array,
    index_: Int,
    value_: String,
) {
...
packed_string_array_size :: proc "contextless" (
    self: ^Packed_String_Array,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_string_array_is_empty :: proc "contextless" (
    self: ^Packed_String_Array,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_string_array_push_back :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_string_array_append :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_string_array_append_array :: proc "contextless" (
    self: ^Packed_String_Array,
...
packed_string_array_remove_at :: proc "contextless" (
    self: ^Packed_String_Array,
    index_: Int,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_string_array_insert :: proc "contextless" (
    self: ^Packed_String_Array,
    at_index_: Int,
    value_: String,
) -> (ret: Int) {
...
packed_string_array_fill :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_string_array_resize :: proc "contextless" (
    self: ^Packed_String_Array,
    new_size_: Int,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_string_array_clear :: proc "contextless" (
    self: ^Packed_String_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_string_array_has :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_string_array_reverse :: proc "contextless" (
    self: ^Packed_String_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_string_array_slice :: proc "contextless" (
    self: ^Packed_String_Array,
    begin_: Int,
    end_: Int,
) -> (ret: Packed_String_Array) {
...
packed_string_array_to_byte_array :: proc "contextless" (
    self: ^Packed_String_Array,
...
packed_string_array_sort :: proc "contextless" (
    self: ^Packed_String_Array,
) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
...
packed_string_array_bsearch :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
    before_: Bool,
) -> (ret: Int) {
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_String_Array, &_gde_name, 1171495151)
    }
    value_ := value_
    before_ := before_
    args := []__bindgen_gde.TypePtr {
...
packed_string_array_duplicate :: proc "contextless" (
    self: ^Packed_String_Array,
) -> (ret: Packed_String_Array) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
    if __ptr == nil {
        _gde_name := new_string_name_cstring("duplicate", true)
        __ptr = __bindgen_gde.variant_get_ptr_builtin_method(.Packed_String_Array, &_gde_name, 747180633)
    }
    args := []__bindgen_gde.TypePtr {
    }
    __ptr(self, raw_data(args), &ret, len(args))
...
packed_string_array_find :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
    from_: Int,
) -> (ret: Int) {
...
packed_string_array_rfind :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
    from_: Int,
) -> (ret: Int) {
...
packed_string_array_count :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
) -> (ret: Int) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
...
packed_string_array_erase :: proc "contextless" (
    self: ^Packed_String_Array,
    value_: String,
) -> (ret: Bool) {
    @(static) __ptr: __bindgen_gde.PtrBuiltInMethod
