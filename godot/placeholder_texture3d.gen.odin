...
placeholder_texture3d_set_size :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 560364750)
    }
    self := self
    size_ := size_
...
placeholder_texture3d_get_size :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2785653706)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
