...
new_gpu_particles_attractor3d :: proc "contextless" () -> Gpu_Particles_Attractor3d {
    return cast(Gpu_Particles_Attractor3d)__bindgen_gde.classdb_construct_object(gpu_particles_attractor3d_name_ref())
}
...
gpu_particles_attractor3d_set_directionality :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_directionality", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 373806689)
    }
    self := self
    amount_ := amount_
...
gpu_particles_attractor3d_get_directionality :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_directionality", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1740695150)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
