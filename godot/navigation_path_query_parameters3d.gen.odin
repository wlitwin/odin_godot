...
Navigation_Path_Query_Parameters3d_Pathfinding_Algorithm :: enum int {
    Pathfinding_Algorithm_Astar = 0,
}
Navigation_Path_Query_Parameters3d_Path_Post_Processing :: enum int {
    Path_Postprocessing_Corridorfunnel = 0,
    Path_Postprocessing_Edgecentered = 1,
    Path_Postprocessing_None = 2,
}

Navigation_Path_Query_Parameters3d_Path_Metadata_Flags :: enum i64 {
