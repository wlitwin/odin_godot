...
rd_vertex_attribute_set_binding :: proc "contextless" (
...
rd_vertex_attribute_get_binding :: proc "contextless" (
    self: Rd_Vertex_Attribute,
) -> (ret: u32) {
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
...
rd_vertex_attribute_set_stride :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_stride", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1286410249)
    }
    self := self
    p_member_ := p_member_
...
rd_vertex_attribute_get_stride :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_stride", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3905245786)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
rd_vertex_attribute_set_frequency :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 522141836)
    }
    self := self
    p_member_ := p_member_
    args := []__bindgen_gde.TypePtr {
...
rd_vertex_attribute_get_frequency :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4154106413)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
