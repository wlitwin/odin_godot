...
fog_volume_set_shape :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1416323362)
    }
    self := self
    shape_ := shape_
    args := []__bindgen_gde.TypePtr {
...
fog_volume_get_shape :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3920334604)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
