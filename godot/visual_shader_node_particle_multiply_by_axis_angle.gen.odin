...
visual_shader_node_particle_multiply_by_axis_angle_set_degrees_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_degrees_mode", true)
...
visual_shader_node_particle_multiply_by_axis_angle_is_degrees_mode :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("is_degrees_mode", true)
...
// properties
visual_shader_node_particle_multiply_by_axis_angle_get_degrees_mode :: proc "contextless" (self: Visual_Shader_Node_Particle_Multiply_By_Axis_Angle) -> Bool {
    return visual_shader_node_particle_multiply_by_axis_angle_is_degrees_mode(self)
}
