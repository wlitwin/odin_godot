...
Visual_Shader_Node_Int_Parameter_Hint :: enum int {
    Hint_None = 0,
    Hint_Range = 1,
    Hint_Range_Step = 2,
    Hint_Enum = 3,
...
visual_shader_node_int_parameter_set_hint :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2540512075)
    }
    self := self
    hint_ := hint_
...
visual_shader_node_int_parameter_get_hint :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4250814924)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
visual_shader_node_int_parameter_set_enum_names :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_enum_names", true)
...
visual_shader_node_int_parameter_get_enum_names :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_enum_names", true)
...
// properties
visual_shader_node_int_parameter_get_default_value_enabled :: proc "contextless" (self: Visual_Shader_Node_Int_Parameter) -> Bool {
    return visual_shader_node_int_parameter_is_default_value_enabled(self)
}
