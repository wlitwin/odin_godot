...
new_physics_direct_body_state3d :: proc "contextless" () -> Physics_Direct_Body_State3d {
    return cast(Physics_Direct_Body_State3d)__bindgen_gde.classdb_construct_object(physics_direct_body_state3d_name_ref())
}
...
physics_direct_body_state3d_get_principal_inertia_axes :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_principal_inertia_axes", true)
...
physics_direct_body_state3d_apply_central_impulse :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2007698547)
    }
    self := self
    impulse_ := impulse_
    args := []__bindgen_gde.TypePtr {
...
// properties
physics_direct_body_state3d_get_sleeping :: proc "contextless" (self: Physics_Direct_Body_State3d) -> Bool {
    return physics_direct_body_state3d_is_sleeping(self)
}
physics_direct_body_state3d_set_sleeping :: proc "contextless" (self: Physics_Direct_Body_State3d, value: Bool) {
    physics_direct_body_state3d_set_sleep_state(self, value)
}
