...
a_star2d_add_point :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 4074201818)
    }
    self := self
    id_ := id_
    position_ := position_
...
a_star2d_get_point_path :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3427490392)
    }
    self := self
    from_id_ := from_id_
    to_id_ := to_id_
...
// properties
a_star2d_get_neighbor_filter_enabled :: proc "contextless" (self: A_Star2d) -> Bool {
    return a_star2d_is_neighbor_filter_enabled(self)
}
