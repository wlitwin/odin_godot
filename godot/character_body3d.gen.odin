...
Character_Body3d_Motion_Mode :: enum int {
    Motion_Mode_Grounded = 0,
    Motion_Mode_Floating = 1,
}
Character_Body3d_Platform_On_Leave :: enum int {
...
new_character_body3d :: proc "contextless" () -> Character_Body3d {
    return cast(Character_Body3d)__bindgen_gde.classdb_construct_object(character_body3d_name_ref())
}
...
character_body3d_set_motion_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2690739026)
    }
    self := self
    mode_ := mode_
    args := []__bindgen_gde.TypePtr {
...
character_body3d_get_motion_mode :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3529553604)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
character_body3d_set_platform_on_leave :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1459986142)
    }
    self := self
...
character_body3d_get_platform_on_leave :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 996491171)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
character_body3d_get_floor_angle :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 2906300789)
    }
    self := self
    up_direction_ := up_direction_
    args := []__bindgen_gde.TypePtr {
...
character_body3d_get_platform_angular_velocity :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_platform_angular_velocity", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3360562783)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
...
character_body3d_get_slide_collision :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 107003663)
    }
    self := self
...
character_body3d_get_last_slide_collision :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 186875014)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
...
// properties
character_body3d_get_slide_on_ceiling :: proc "contextless" (self: Character_Body3d) -> Bool {
    return character_body3d_is_slide_on_ceiling_enabled(self)
}
character_body3d_set_slide_on_ceiling :: proc "contextless" (self: Character_Body3d, value: Bool) {
    character_body3d_set_slide_on_ceiling_enabled(self, value)
}
character_body3d_get_floor_stop_on_slope :: proc "contextless" (self: Character_Body3d) -> Bool {
    return character_body3d_is_floor_stop_on_slope_enabled(self)
}
character_body3d_set_floor_stop_on_slope :: proc "contextless" (self: Character_Body3d, value: Bool) {
    character_body3d_set_floor_stop_on_slope_enabled(self, value)
}
character_body3d_get_floor_constant_speed :: proc "contextless" (self: Character_Body3d) -> Bool {
    return character_body3d_is_floor_constant_speed_enabled(self)
}
character_body3d_set_floor_constant_speed :: proc "contextless" (self: Character_Body3d, value: Bool) {
    character_body3d_set_floor_constant_speed_enabled(self, value)
}
character_body3d_get_floor_block_on_wall :: proc "contextless" (self: Character_Body3d) -> Bool {
    return character_body3d_is_floor_block_on_wall_enabled(self)
}
character_body3d_set_floor_block_on_wall :: proc "contextless" (self: Character_Body3d, value: Bool) {
    character_body3d_set_floor_block_on_wall_enabled(self, value)
}
