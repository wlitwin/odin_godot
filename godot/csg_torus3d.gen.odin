...
new_csg_torus3d :: proc "contextless" () -> Csg_Torus3d {
    return cast(Csg_Torus3d)__bindgen_gde.classdb_construct_object(csg_torus3d_name_ref())
}
...
csg_torus3d_set_ring_sides :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("set_ring_sides", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 1286410249)
    }
    self := self
    sides_ := sides_
...
csg_torus3d_get_ring_sides :: proc "contextless" (
    ...
    @(static) __ptr: __bindgen_gde.MethodBindPtr
    if __ptr == nil {
        _gde_name := new_string_name_cstring("get_ring_sides", true)
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 3905245786)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
