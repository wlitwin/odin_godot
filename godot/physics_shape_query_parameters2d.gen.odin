...
// properties
physics_shape_query_parameters2d_get_collide_with_bodies :: proc "contextless" (self: Physics_Shape_Query_Parameters2d) -> Bool {
    return physics_shape_query_parameters2d_is_collide_with_bodies_enabled(self)
}
physics_shape_query_parameters2d_get_collide_with_areas :: proc "contextless" (self: Physics_Shape_Query_Parameters2d) -> Bool {
    return physics_shape_query_parameters2d_is_collide_with_areas_enabled(self)
}
