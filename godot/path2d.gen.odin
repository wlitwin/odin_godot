...
new_path2d :: proc "contextless" () -> Path2d {
    return cast(Path2d)__bindgen_gde.classdb_construct_object(path2d_name_ref())
}
...
path2d_set_curve :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 659985499)
    }
    self := self
    curve_ := curve_
...
path2d_get_curve :: proc "contextless" (
    ...
    if __ptr == nil {
        ...
        __ptr = __bindgen_gde.classdb_get_method_bind(&__class_name, &_gde_name, 660369445)
    }
    self := self
    args := []__bindgen_gde.TypePtr {
    }
